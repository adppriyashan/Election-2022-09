    ...
    <div class="container">
        ...
        <div class="card mt-4">
            <div class="card-body justify-content-center text-center">
                ...
                <form action="/enrollVote" method="POST">
                    @csrf

                    <input type="text" id="user_id" name="user_id" value="{{ $voter->id }}" hidden />
                    <h3>Hello, {{ $voter->name }}. <br>Welcome to Election Voting System</h3>
                    <p>Please vote your candidate</p>
                        ...
                        <table class="table table-bordered">
                            ...
                            @foreach ($candidates as $candidate)
                                <tr>
                                    ...
                                    <td>
                                        <input type="radio" id="candidate_id" name="candidate_id"
                                            value="{{ $candidate->id }}">
                                    </td>
                                </tr>
                            @endforeach
                    ...
                    <div class="justify-content-center">
                        <input type="submit" class="btn btn-primary" value="Submit Your Vote">
                    </div>
