<div class="sidebar sidebar-dark sidebar-fixed" id="sidebar">
    <div class="sidebar-brand d-none d-md-flex">
        <svg class="sidebar-brand-full" width="118" height="46" alt="Election Logo">
            <use xlink:href="assets/brand/coreui.svg#full"></use>
        </svg>
        <svg class="sidebar-brand-narrow" width="46" height="46" alt="Election Logo">
    ...
    <ul class="sidebar-nav" data-coreui="navigation" data-simplebar="">
        ...
        <li class="nav-title">Enrollment</li>
        ...
        <li class="nav-group"><a class="nav-link nav-group-toggle" href="#">
            ...
            <ul class="nav-group-items">
                <li class="nav-item"><a class="nav-link" href="/users" target="_top">
                        <svg class="nav-icon">
                            <use xlink:href="vendors/@coreui/icons/svg/free.svg#cil-level-up"></use>
                        </svg>Users Manage</a></li>
                <li class="nav-item"><a class="nav-link" href="/logout" target="_top">
                        <svg class="nav-icon">
