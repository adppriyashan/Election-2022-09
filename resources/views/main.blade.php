        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-body justify-content-center text-center">
                    ...
                    <h1>Welcome to Election Voting System</h1>
                    <p>Please put your finger on Finger Print machine and click next button to proceed your vote</p>
                    <form action="/verifyVoter" method="GET">
                        <input type="text" id="id" name="id" value="1" hidden />
                        <input type="text" id="source" name="source" value="2" hidden />
